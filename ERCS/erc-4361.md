...
- Why [ERC-191](./erc-191.md) (Signed Data Standard) over [EIP-712](https://eips.ethereum.org/EIPS/eip-712) (Ethereum typed structured data hashing and signing)
    ...
    - [ERC-191](./erc-191.md) produces more human-readable messages, while [EIP-712](https://eips.ethereum.org/EIPS/eip-712) creates signing outputs for machine consumption, with most wallets not displaying the payload to be signed in a manner friendly to humans. **(1)**![](../assets/eip-4361/signing.png)
